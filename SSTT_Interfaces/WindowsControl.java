    ...
    public static void main(String[] args) {
	    ...
	    Microphone microphone = (Microphone) cm.lookup("microphone");
			...
			if(resultText.equals("කොමාන්ඩ්"))
 			...
 			if (resultText.equals("කැල්ක්යුලේටරය"))
 		    {
 		        try{
 		        Process p;	//resultText="";
 			...
 			else if(resultText.equalsIgnoreCase("පේන්ට්"))
 			{	 try{
 				        Process p;
 				    	//resultText="";
 			...
 			else if(resultText.equals("ෆේස්බුක්"))
 			{	 try{
 		        Process p;
 		    	//resultText="";
 			...
 			else if(resultText.equals("ගුගල්"))
 			{	 try{
 		        Process p;
 		    	//resultText="";
